...
SOURCEFILES_QUOTED_IF_SPACED=Slave_main.c DIO.c Slave_SPI.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Slave_main.o ${OBJECTDIR}/DIO.o ${OBJECTDIR}/Slave_SPI.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Slave_main.o.d ${OBJECTDIR}/DIO.o.d ${OBJECTDIR}/Slave_SPI.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Slave_main.o ${OBJECTDIR}/DIO.o ${OBJECTDIR}/Slave_SPI.o

# Source Files
SOURCEFILES=Slave_main.c DIO.c Slave_SPI.c
...
${OBJECTDIR}/Slave_SPI.o: Slave_SPI.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Slave_SPI.o.d 
	@${RM} ${OBJECTDIR}/Slave_SPI.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp=${DFP_DIR}  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/Slave_SPI.o.d" -MT "${OBJECTDIR}/Slave_SPI.o.d" -MT ${OBJECTDIR}/Slave_SPI.o -o ${OBJECTDIR}/Slave_SPI.o Slave_SPI.c 
